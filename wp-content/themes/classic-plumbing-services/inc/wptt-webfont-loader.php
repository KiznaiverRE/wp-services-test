...
if ( ! class_exists( 'Classic_Plumbing_Services_WPTT_WebFont_Loader' ) ) {
	/**
	 * Download webfonts locally.
	 */
	class Classic_Plumbing_Services_WPTT_WebFont_Loader {
		...
		public function get_remote_url_contents() {
			...
			$classic_plumbing_services_contents = wp_remote_retrieve_body( $response );

			return $classic_plumbing_services_contents;
		}
...
if ( ! function_exists( 'classic_plumbing_services_wptt_get_webfont_styles' ) ) {
	/**
	 ...
	 */
	function classic_plumbing_services_wptt_get_webfont_styles( $url, $format = 'woff2' ) {
		$font = new Classic_Plumbing_Services_WPTT_WebFont_Loader( $url );
		$font->set_font_format( $format );
		return $font->get_styles();
	}
}

if ( ! function_exists( 'classic_plumbing_services_wptt_get_webfont_url' ) ) {
	/**
	 ...
	 * @return string Returns the CSS.
	 */
	function classic_plumbing_services_wptt_get_webfont_url( $url, $format = 'woff2' ) {
		$font = new Classic_Plumbing_Services_WPTT_WebFont_Loader( $url );
		$font->set_font_format( $format );
		return $font->get_url();
	}
