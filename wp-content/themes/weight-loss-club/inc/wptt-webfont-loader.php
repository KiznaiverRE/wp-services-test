...
if ( ! class_exists( 'Weight_Loss_Club_WPTT_WebFont_Loader' ) ) {
	/**
	 * Download webfonts locally.
	 */
	class Weight_Loss_Club_WPTT_WebFont_Loader {
		...
		public function get_remote_url_contents() {
			...
			$weight_loss_club_contents = wp_remote_retrieve_body( $response );

			return $weight_loss_club_contents;
		}
...
if ( ! function_exists( 'weight_loss_club_wptt_get_webfont_styles' ) ) {
	/**
	 ...
	 */
	function weight_loss_club_wptt_get_webfont_styles( $url, $format = 'woff2' ) {
		$font = new Weight_Loss_Club_WPTT_WebFont_Loader( $url );
		$font->set_font_format( $format );
		return $font->get_styles();
	}
}

if ( ! function_exists( 'weight_loss_club_wptt_get_webfont_url' ) ) {
	/**
	 ...
	 * @return string Returns the CSS.
	 */
	function weight_loss_club_wptt_get_webfont_url( $url, $format = 'woff2' ) {
		$font = new Weight_Loss_Club_WPTT_WebFont_Loader( $url );
		$font->set_font_format( $format );
		return $font->get_url();
	}
