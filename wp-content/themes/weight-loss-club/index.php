...
<div class="box-image">
    ...
    <div class="page-header">
        <h2><?php esc_html_e( 'Home', 'weight-loss-club' ); ?></h2>
    </div>
...
<div class="container">
    <div id="content" class="contentsecwrap">
        <section class="site-main">
            ...
            <?php
            elseif ($weight_loss_club_sidebar_layout == 'right') :
            ?>
                <div class="row m-0">
                    <div class="col-lg-8 col-md-8">
                        <div class="postsec-list">
            ...
            <?php
            elseif ($weight_loss_club_sidebar_layout == 'full') :
            ?>
                <div class="full">
                    <div class="postsec-list">
                        <?php
            ...
            <?php
            elseif ($weight_loss_club_sidebar_layout == 'three-column') :
            ?>
                <div class="row m-0">
            ...
            <?php
            elseif ($weight_loss_club_sidebar_layout == 'four-column') :
            ?>
                <div class="row m-0">
                    <div class="col-lg-3 col-md-3" id="sidebar">
                        <?php dynamic_sidebar('sidebar-1'); ?>
            ...
            <?php
            elseif ($weight_loss_club_sidebar_layout == 'grid') :
            ?>
                <div class="row m-0">
